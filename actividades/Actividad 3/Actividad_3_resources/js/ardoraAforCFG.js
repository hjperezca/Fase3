...
var words=["RElTRdFPIERFIFNJVElPUyBXRUI","","","","","","","","",""];imaW=["","","","","","","","","",""];queW=["¿Como se Llama el Curso que Estamos Viendo?","","","","","","","","",""];
var auW=["","","","","","","","","",""];
var fillLetter="ABCDEFGHIJKLMNÑOPQRSTUVWXYZÁÉÍÓÚÜ "; wordsG=[]; indexG=0; actMaxWidth=550; indexWord=0; totalWord=0;
var imageW=[];questionW=[];audioW=[];profG=0; dirMedia="Actividad_3_resources/media/"; textBNext="";
